...
if ($USER->IsAdmin()) {?>
	...
	<style>
		.prod__right .product-item-scu-item-color-container[data-onevalue="4750"],
		.product__list .product-item-scu-item-color-container[data-onevalue="4750"] {
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEARCH_REGEXP_FOR_EXCEPTION" => [
			"гель для душа" => "#ГЕЛ([^\s\/]{0,3})( ДЛЯ |\/)ДУШ([\S]{0,3})#iu"
		],
	),
	false
); ?>
