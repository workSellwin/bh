...
//        die();
    ...
    private function addQueue($fUserId, $userId, $productId, $phone, $smsTemplate, $bindOrder, $price){

        if( !isset($this->queue[$phone]) || $this->queue[$phone]->getPrice() < $price ){
            $this->queue[$phone] = new Subscriber( $fUserId, $userId, $productId, $phone, $smsTemplate, $bindOrder, $price);
        }
        //$this->queue[$phone] = new Subscriber( $fUserId, $userId, $productId, $phone, $smsTemplate, $bindOrder);
    }
...
class Subscriber{
    ...
    function __construct($fUser, $userId, $good, $phone, $message, $bindOrder, $price)
    {
        //$this->phone = $phone;
