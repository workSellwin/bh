...
function CreatDiscountCoupon(){
    $coupon = new createDiscountCoupon([1895, 1896]);
    $text_coupon = $coupon->GetCode();
    $coupon -> sendEmail('d.maznyak@sellwin.by, dianabsu11@gmail.com', $text_coupon);

    return "CreatDiscountCoupon();";
}
