<style>
    .prod__right .product-item-scu-item-color-container[data-onevalue="<?= CATALOG_CUSTOM_CERT_ENUM ?>"],
    .product__list .product-item-scu-item-color-container[data-onevalue="<?= CATALOG_CUSTOM_CERT_ENUM ?>"]{
