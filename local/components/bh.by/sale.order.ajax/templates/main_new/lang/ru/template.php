...
$MESS["SOA_ORDER_SUC"] = "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# успешно создан. Благодарим за заказ!<br><br><b>Вы получите SMS-уведомление</b> о подтверждении заказа с указанием даты, времени доставки и контактными данными курьера.<br><br><b>ВНИМАНИЕ!</b> Мы не перезваниваем для подтверждения заказа. <br>";
$MESS["SOA_PAYMENT_SUC"] = "Номер вашей оплаты: <b>№#PAYMENT_ID#</b>";
$MESS["SOA_ORDER_SUC1"] = "Вы можете <b>следить за выполнением своего заказа</b> в <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
...
$MESS["REGION_BLOCK_NAME_DEFAULT"] = "Профили покупателя";//"Регион доставки";
