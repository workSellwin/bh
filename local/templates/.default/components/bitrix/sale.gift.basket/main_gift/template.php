...
if (!empty($arResult['ITEMS'])) {
                                ...
                                foreach ($arProp['VALUES'] as &$arOneValue) {
                                    if ($arOneValue["ID"] == $value["PROPERTIES"][$arProp["CODE"]]["VALUE_ENUM_ID"]) {
                                        if (!empty($value["PREVIEW_PICTURE"]["SRC"])) {
                                            ...
                                            $arOneValue["PICT"] = $value["DETAIL_PICTURE"];
                                        }
                                    }
                                }
                            }
                ...
                <div class="product-item-scu-container" id="#ITEM#_prop_<? echo $arProp['ID']; ?>_cont">
                    <div class="product-item-scu-block">
                        ...
                        <div class="bx_slide_left" id="#ITEM#_prop_<? echo $arProp['ID']; ?>_left"
                             data-treevalue="<? echo $arProp['ID']; ?>" style="display: none;"></div>
    ...
    <?if($arResult['FRAUD'] == 'Y'){?>
        <span class="FRAUD" data-fraud="<?=$arResult['FRAUD']?>" data-url="<?=$APPLICATION->GetCurPage()?>"></span>
    <?}?>
    ...
    <div class="bx_item_list_you_looked_horizontal col<? echo $arParams['LINE_ELEMENT_COUNT']; ?>">
        ...
        <? if (empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y') { ?>
            <div class="h1"><? echo($arParams['BLOCK_TITLE'] ? htmlspecialcharsbx($arParams['BLOCK_TITLE']) : GetMessage('SGB_TPL_BLOCK_TITLE_DEFAULT')) ?></div><? } ?>
            ...
            <div class="bx_item_list_slide active product__list"><?
                ...
                foreach ($arResult['ITEMS'] as $k => $arItems) {
                    ...
                    <div id="gifts_box_<?= $arResult['arDiscounts'][$k]['GIFT_VAL'] ?>" class="gifts_box" data-gift="<?= $arResult['arDiscounts'][$k]['GIFT_VAL'] ?>"
                         style="<?= $arResult['arDiscounts'][$k]['ACTIV_GIFT'] == 'N' ? 'opacity: 0.5' : '' ?>">

                        <div class="related__ttl" style="text-align: left" ><?=  $arResult['arDiscounts'][$k]['NEED'] ?></div>


                        <div class="prod-other__slider_new carousel " data-entity="<?=$k.$arItems['ID']?>">
                             ...
                             <?foreach ($arItems as $key => $arItem) {
                                ...
                                <div class="product__col" id="<?= $strMainID; ?>">
                                    <div class="prod__item-container <?= $showImgClass; ?> gmi-gift-hover">
                                        <div class="prod-item">
                                            <span class="prod-status">
                                                <span>
                                                    <span title="<?= $arItem['LABEL_VALUE']; ?>"
                                                          class="prod-status__item "><?= $arItem['LABEL_VALUE']; ?></span>
                                                    <span id="<?= $arItemIDs['DSC_PERC']; ?>"
                                                          class="prod-status__item prod-status__item-describe">-<?= $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT']; ?>%</span>
                                                </span>
                                            </span>
                                            <a id="<?= $arItemIDs['PICT']; ?>"
                                            ...
                                            if ($arItem['SECOND_PICT']) {
                                                ?><a id="<? echo $arItemIDs['SECOND_PICT']; ?>"
                                                     ...
                                                     class="hidden hide"<? if ($arParams['SHOW_IMAGE'] == "Y") {
                                            ...
                                            ?>
                                            <a class="prod-name" href="<?= $arItem['DETAIL_PAGE_URL']; ?>"
                                                    ...
                                                    <div class="bx_catalog_item_controls"><?
                                                        if ($arItem['CAN_BUY'] || in_array($arItem['ID'], [43461, 43462, 43463]) ) {
                                                            ...
                                                            <div class="bx_catalog_item_controls_blocktwo">
                                                                <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn btn_ico btn-lod-js"
