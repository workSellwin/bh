...
<?php
if($arResult["VARIABLES"]["SECTION_CODE"] == 'professionnel' ) {
    include $_SERVER['DOCUMENT_ROOT'] . '/local/include/professionnel.php';
}
elseif($arResult["VARIABLES"]["SECTION_CODE"] == 'matrix'){
    include $_SERVER['DOCUMENT_ROOT'] . '/local/include/matrix.php';
}
?>